...
#include <Drv/LinuxSpiDriver/LinuxSpiDriver.hpp>
...
// The reference topology divides the incoming clock signal (10Hz) into sub-signals: 10Hz, 1Hz, and 1/2Hz with 0 offset
Svc::RateGroupDriver::DividerSet rateGroupDivisorsSet{{{1, 0}, {10, 0}, {20, 0}}};
...
void setupTopology(const TopologyState& state) {
    ...
    spiDriver.open(0, 0, Drv::SPI_FREQUENCY_5MHZ, Drv::SPI_MODE_CPOL_LOW_CPHA_LOW);

    radioResetPin.open("/dev/gpiochip0", 22, Drv::LinuxGpioDriver::GPIO_OUTPUT, Fw::Logic::LOW);
    radioChipSelectPin.open("/dev/gpiochip0", 25, Drv::LinuxGpioDriver::GPIO_OUTPUT, Fw::Logic::HIGH);
