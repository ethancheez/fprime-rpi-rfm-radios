module MyDeployment {
  ...
  instance spiDriver: Drv.LinuxSpiDriver base id 0x4B00

  instance radioResetPin: Drv.LinuxGpioDriver base id 0x10000
  
  instance radioChipSelectPin: Drv.LinuxGpioDriver base id 0x10100

  instance radioInterruptPin: Drv.LinuxGpioDriver base id 0x10200
